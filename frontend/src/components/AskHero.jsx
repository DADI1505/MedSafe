...
export default function AskHero({ onSubmit, isLoading }) {
  ...
  return (
    // Conteneur relatif qui accueille le dégradé en position absolue derrière le contenu
    <div className="relative flex min-h-[70vh] items-center justify-center overflow-hidden px-4">
      {/* Le dégradé radial : centré, dans la couleur de marque, très discret */}
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background:
            "radial-gradient(circle at 50% 40%, var(--color-brand-600) 0%, transparent 55%)",
          opacity: 0.12,
        }}
        aria-hidden="true"
      />

      {/* Le contenu reste au-dessus du dégradé grâce à z-10 */}
